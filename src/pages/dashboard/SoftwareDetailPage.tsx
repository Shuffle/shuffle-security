...
import { ArrowLeft, Package, ExternalLink, ShieldAlert, Info, Clock } from 'lucide-react';
...
const SoftwareDetailPage = () => {
  ...
  usePageMeta({ title: `${name} — Software`, description: `Software detail for ${name}` });

  // Reference links for popular package registries / vulnerability DBs
      ...
      <div className="rounded-lg border border-border bg-card p-5 space-y-5">
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground pl-6">
            Check the reference links below to determine if the installed version is current or outdated. Cross-reference with the host's installed version in the Monitors view.
          </p>
        </div>
