/**
 * AddAppModal — Two-phase modal for finding and authenticating apps.
 *
 ...
 *
 * Self-contained: lives in Shuffle-MCPs so it can be used inside the library
 * (e.g., AppSearchDrawer) without host-app imports.
 */
