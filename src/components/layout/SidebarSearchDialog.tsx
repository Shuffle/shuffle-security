...
import type { AlgoliaSearchApp } from '@/Shuffle-MCPs/singul.helpers';
...
const navItems: NavResult[] = [
  ...
  { type: 'nav', label: 'Threat Feeds', path: '/detection/threat-feeds', icon: <RssFeedIcon sx={{ fontSize: 16 }} />, indent: true },
  { type: 'nav', label: 'IOC Types', path: '/detection/ioc-types', icon: <FingerprintIcon sx={{ fontSize: 16 }} />, indent: true },
