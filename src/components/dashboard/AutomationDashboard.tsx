 ...
 *
 * Mirrors the look of the classic Shuffle (shuffler.io) dashboard.
 */
import { useEffect, useMemo, useState } from 'react';
import { Box, Typography, Skeleton, IconButton, Tooltip as MuiTooltip } from '@mui/material';
import {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, mt: 2 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 2, flexWrap: 'wrap' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
          <Box sx={{ minWidth: 110 }}>
            <Typography sx={{ fontSize: '0.65rem', color: 'hsl(var(--muted-foreground))', mb: 0.25, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
              Last
            </Typography>
