...
export const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: 'incident-detail',
    title: 'Use the data the agent has gathered',
    body: 'You have a lot of data already — Tasks, Observables, an Activity feed. The hard part is using it. Walk through the evidence, ask the agent a question, and watch a fresh correlation arrive.',
    bullets: [
      'Open the Tasks tab — these are auto-generated by the agent',
      'Open Observables — some of them are flagged as bad',
    ...
    requirement: {
      label: 'Walk through Tasks, Observables, and ask the agent',
      targetSelector: '[data-tour="incident-activity-feed"]',
    },
    subGoals: [
      {
        id: 'incident-detail:tasks',
        label: 'Open the Tasks tab — agent-generated work',
        targetSelector: '[data-tour="incident-tab-tasks"]',
      },
      {
        id: 'incident-detail:observables',
        label: 'Open Observables — check which ones are bad',
